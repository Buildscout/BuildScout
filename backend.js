window.BuildScoutBackend = (() => {
  ...
  return {configured,init,getClient,signUp,signIn,signOut,getSession,getProjects,getProjectDocuments,getProjectDocumentCounts,importProjects,getSavedProjects,saveProject,unsaveProject,getPipeline,removePipelineItem,updatePipeline,getContacts,saveContact,deleteContact,setPrimaryContact,getActivities,addActivity,completeActivity,getAlerts,saveAlert,updateAlert,deleteAlert,getMatchingProjects};
})();
