...
export default async function handler(req,res){
  ...
  if(!companyResearchProviderConfigured())return res.status(503).json({status:"provider_not_configured",required:["COMPANY_ENRICHMENT_API_URL","COMPANY_ENRICHMENT_API_KEY"]});
